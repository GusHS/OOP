...
public class Proyecto extends JFrame implements ActionListener{
    ...
    private JMenu           menuOpciones, menuCalculos, menuGrados, menuAudio,menuLibros;
    private JMenuItem       miGradosCF, miGradosFC, miExponencial, miFactorial;
    private JMenuItem       miAudioWAV, miAudioFX, miAudioZoom, miAudioTunes,miBiblioteca,miConsulta; 
    ...
    private BibliotecaGUIImg bibliotecaGUIImg;
    ...
    public Proyecto() throws Exception{
        ...
        miConsulta      = new JMenuItem("Consulta de Libros");
        ...
        libroGUI        = new LibroGUI();
        bibliotecaGUIImg = new BibliotecaGUIImg();
        ...
        miBiblioteca.addActionListener(this);
        ...
        menuLibros.add(miBiblioteca);
        menuLibros.add(miConsulta);
        mbPrincipal.add(menuCalculos);
        mbPrincipal.add(menuAudio);
        mbPrincipal.add(menuLibros);
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if (e.getSource()==miConsulta) {
            panel.setVisible(false);
            panel = libroGUI.getPanel2();
            panel.setVisible(true);
            add(panel);
        }
        if (e.getSource()==miBiblioteca) {
            panel.setVisible(false);
            panel = bibliotecaGUIImg.getPanel2();
            panel.setVisible(true);
            add(panel);
        }
